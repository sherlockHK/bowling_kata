...
public class GameTest {
    ...
    @Test
    public void shouldCalculateGameTotalScore() {
        ...
        LastRound lastRound = new LastRound(1,2,3);
        ...
        assertEquals(105,game.calculateTotalScore());
    }

    @Test
    public void shouldCalculatePerfectGameTotalScore() {
        Round round1 = new Round(10,0);
        Round round2 = new Round(10,0);
        Round round3 = new Round(10,0);
        Round round4 = new Round(10,0);
        Round round5 = new Round(10,0);
        Round round6 = new Round(10,0);
        Round round7 = new Round(10,0);
        Round round8 = new Round(10,0);
        Round round9 = new Round(10,0);
        LastRound lastRound = new LastRound(10,10,10);
